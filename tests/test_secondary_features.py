...
class TestSaving(unittest.TestCase):
    ...
    def test_secondary_feature_generation(self):
        ...
        update_secondary_features(self.dir_config)
        self.assertTrue(self.dir_config.DAILY_SECONDARY_FEATURES_DIR.exists())
        self.assertTrue(self.dir_config.DAILY_SECONDARY_FEATURES_DIR.is_dir())
